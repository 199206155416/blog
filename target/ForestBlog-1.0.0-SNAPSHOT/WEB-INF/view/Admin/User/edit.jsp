...
<rapid:override name="footer-script">
    ...
    <script>
        ...
        //     formData.append("key", "boss/c7fe40bbf5ddcf9a879b9ba17e4bfe6c");
        //     formData.append("token", "3UYDAPEghOraJO8WLZU-QYZ_kPzlTMjAbSOdRQi5:uGNzmXgdluuoBd8CviNfwazLQRM=:eyJzY29wZSI6ImppbXUtY29tbXVuaXR5LWJvc3MiLCJkZWFkbGluZSI6MTU5MjIyMjMyNn0=");
        ...
        $.ajax({
            url: "/config/image/getUploadToken?fileNameNumber=1",
            type: "get",
            success: function(e) {
                //上传图片
                layui.use('upload', function () {
                    ...
                    var uploadInst = upload.render({
                        ...
                        before: function (obj) {
                            ...
                            $("#userAvatar").attr("value", e.qiNiuUrl + res.key);
                            if (res.code > 0) {
